...
LAYOUTS: dict[str, dict[str, Any]] = {
    ...
    "COL_DFN": {"name": "컬럼정의서", "sheet": "컬럼정의서", "items": [("MPG_ID", "테이블매핑ID"), ("PRJ_CD", "프로젝트코드"), ("SBJ_AREA_CD", "주제영역코드"), ("TGT_SCH_NM", "대상스키마명"), ("TGT_TBL_NM", "대상테이블명"), ("SRC_SCH_NM", "원천스키마명"), ("SRC_TBL_NM", "원천테이블명"), ("COL_ORD", "매핑순서"), ("TGT_COL_NO", "대상컬럼순번"), ("TGT_COL_NM", "대상컬럼명"), ("TGT_COL_CMT", "대상컬럼설명"), ("TGT_DATA_TYPE", "대상데이터타입"), ("TGT_NULL_YN", "대상NULL허용"), ("TGT_KEY_ROLE_CD", "대상키역할"), ("COL_MPG_MTHD_CD", "컬럼매핑방식"), ("TGT_EXPR", "이행적용SQL식"), ("DFLT_EXPR", "이행기본값SQL식"), ("SRC_REF_COL_NM_ARR", "원천참조컬럼명"), ("SRC_COL_NO", "원천컬럼순번"), ("SRC_COL_NM", "원천컬럼명"), ("SRC_DATA_TYPE", "원천데이터타입"), ("SRC_NULL_YN", "원천NULL허용"), ("SRC_KEY_ROLE_CD", "원천키역할"), ("SUM_VALD_YN", "SUM검증여부"), ("HSH_VALD_YN", "HASH검증여부")]},
    "MPG_DFN": {"name": "매핑정의서", "sheet": "매핑정의서", "items": [("MPG_ID", "테이블매핑ID"), ("PRJ_CD", "프로젝트코드"), ("SBJ_AREA_CD", "주제영역코드"), ("TGT_CONN_ID", "대상접속ID"), ("TGT_SCH_NM", "대상스키마명"), ("TGT_TBL_NM", "대상테이블명"), ("SRC_CONN_ID", "원천접속ID"), ("SRC_SCH_NM", "원천스키마명"), ("SRC_TBL_NM", "원천테이블명"), ("COL_ORD", "매핑순서"), ("TGT_COL_NM", "대상컬럼명"), ("TGT_DATA_TYPE", "대상데이터타입"), ("COL_MPG_MTHD_CD", "컬럼매핑방식"), ("TGT_EXPR", "이행적용SQL식"), ("DFLT_EXPR", "이행기본값SQL식"), ("SRC_REF_COL_NM_ARR", "원천참조컬럼명"), ("SRC_COL_NM", "원천컬럼명"), ("SUM_VALD_YN", "SUM검증여부"), ("HSH_VALD_YN", "HASH검증여부")]},
